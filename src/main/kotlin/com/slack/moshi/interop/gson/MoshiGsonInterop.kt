...
/**
 * An interop-ing [JsonAdapter.Factory] that tries to intelligently defer to a given [gson] instance for appropriate
 * types.
 */
...
/**
 * An interop-ing [TypeAdapterFactory] that tries to intelligently defer to a given [moshi] instance for appropriate
 * types.
 */
